...
1. Load `~/.claude/plugins/config/claude-for-legal/employment-legal/CLAUDE.md` → dismissal review triggers, high-risk flags, notice/severance practice, jurisdiction.
...
`~/.claude/plugins/config/claude-for-legal/employment-legal/CLAUDE.md` → dismissal review triggers, high-risk flags, standard notice/severance practice, jurisdiction table.

## Output header

Prepend the work-product header from `~/.claude/plugins/config/claude-for-legal/employment-legal/CLAUDE.md` → `## Outputs` (it differs by user role — see `## Who's using this`). Match the memo format from seed dismissal memos referenced in that config where one exists. The work-product header is always first.
...
Per `~/.claude/plugins/config/claude-for-legal/employment-legal/CLAUDE.md` → standard notice and severance practice:
...
Match the memo format from seed dismissal memos referenced in `~/.claude/plugins/config/claude-for-legal/employment-legal/CLAUDE.md`. If none:
...
**Before producing a "Go" recommendation or a dismissal-day checklist marked ready:** Read `## Who's using this` in `~/.claude/plugins/config/claude-for-legal/employment-legal/CLAUDE.md`. If the Role is **Non-lawyer**:
